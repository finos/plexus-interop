...
[source, bash]
-----
bin/win-x86/samples/apps/ElectronAppLauncher/ElectronAppLauncher.exe --brokerDir . --apps "./web/packages/ccy-pair-rate-provider/dist/index.html;./web/packages/ccy-pair-rate-viewer/dist/index.html"
-----
