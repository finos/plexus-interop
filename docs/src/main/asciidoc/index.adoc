...
=== Desktop Interop Standards

==== Overview
include::spec-desktop-interop-overview.adoc[]

==== Requirements
include::spec-desktop-interop-requirements.adoc[]

==== Concepts
include::spec-desktop-interop-concepts.adoc[]
